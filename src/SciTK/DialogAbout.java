 ...
 */
public class DialogAbout extends SciTK_Dialog
{
    /** whether we should display extra info */
    private boolean display_app_info;
    /** an icon for the app using this toolkit */
    private ImageIcon app_icon;
    /** info about the app using this toolkit */
    private String[] app_info;
    /** for implementing the above app info */
    private List<JLabel> app_info_label;
    ...
    */
    public DialogAbout(ImageIcon app_icon_in, String[] app_info_in)
    {
        super();
    ...
    */
    public DialogAbout(Font custom_font, float custom_align)
    {
    ...
    * @param custom_align The alignment to use for all UI elements (0=left, 0.5=center, 1=right)
    */
    public DialogAbout(ImageIcon app_icon_in, String[] app_info_in, Font custom_font, float custom_align)
    {
        super(custom_font,custom_align);
        display_app_info = true;
    ...
    private final void initUI()
    {
        ...
        try
        {
            ImageIcon icon = new ImageIcon(getClass().getResource("/SciTK/resources/SciTK_logo.png"));
