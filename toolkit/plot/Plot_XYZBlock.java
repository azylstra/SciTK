...
public class Plot_XYZBlock extends Plot
{
    ...
    */
    public Plot_XYZBlock(float[][] data_in)
    {
     ...
     * @param data_in the data to plot (must be an array with length 3, containing three arrays of equal length, the first containing the x-values, the second containing the y-values and the third containing the z-values).
    */
    public Plot_XYZBlock(double[][] data_in)
    {
        // call other constructor:
    ...
    */
    public Plot_XYZBlock(float[][] data_in, String name)
    {
        // call other constructor:
     ...
     * @param name the data set's name
    */
    public Plot_XYZBlock(double[][] data_in, String name)
    {
        // call other constructor:
    ...
    */
    public Plot_XYZBlock(float[][] data_in, String name, String x_label, String y_label)
    {
        // call other constructor:
     ...
     * @param y_label the label for the ordinate
    */
    public Plot_XYZBlock(double[][] data_in, String name, String x_label, String y_label)
    {
        // call other constructor:
    ...
    */
    public Plot_XYZBlock(float[][] data_in, String name, String x_label, String y_label, String window_title)
    {
        // call other constructor:
	 ...
	 * @param window_title a label for the window title
	*/
	public Plot_XYZBlock(double[][] data_in, String name, String x_label, String y_label, String window_title)
	{
    ...
    */
     ...
     */
    public void set_scalebar(boolean enabled)
    {
