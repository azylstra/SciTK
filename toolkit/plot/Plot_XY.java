...
public class Plot_XY extends Plot
{
	...
	*/
	public Plot_XY(float[][] data_in, String name)
	{
		// call other constructor:
	...
	* @param name the data set's name
	*/
	public Plot_XY(double[][] data_in, String name)
	{
		// call other constructor:
		this(data_in, name, DEFAULT_XLABEL, DEFAULT_YLABEL, DEFAULT_TITLE);
	}
	...
	*/
	public Plot_XY(float[][] data_in, String name, String x_label, String y_label)
	{
		// call other constructor:
	...
	* @param y_label the label for the ordinate
	*/
	public Plot_XY(double[][] data_in, String name, String x_label, String y_label)
	{
		// call other constructor:
		this(data_in, name, x_label, y_label, DEFAULT_TITLE);
	}
	...
	*/
	public Plot_XY(float[][] data_in, String name, String x_label, String y_label, String window_title)
	{
		// call other constructor:
	...
	* @param window_title a label for the window title
	*/
	public Plot_XY(double[][] data_in, String name, String x_label, String y_label, String window_title)
	{
